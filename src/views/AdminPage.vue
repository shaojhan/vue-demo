...
import type { AssignEmployeeResponse, CsvUploadResponse } from '@/api'
import {
...
// 表格欄位定義（角色 label/顏色為會員表格專用，故置於 columns 模組）
const userColumns = createUserColumns()
const employeeColumns = createEmployeeColumns(departmentLabels)
